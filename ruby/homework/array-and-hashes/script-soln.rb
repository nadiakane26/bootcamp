...
puts "First element: #{fruit.first}, Last element: #{fruit.last}"
...
puts "Modified Fruits: #{fruit}"

# Check if "apple" is in the array and print the result.
puts "Is 'apple in the array? #{fruit.include?("apple")? "Yes" : "No"}"

# Calculate and print the total number of fruits in the fruits array.
puts "Total number of fruits: #{fruit.length}" 
...
puts "Modified Student Info: #{student}"
